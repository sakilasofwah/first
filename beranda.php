    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Selamat Datang di Dinas Perdagangan Dan Perindustrian Kota Tanjung Balai</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Agenda Surat Masuk Dan Surat Keluar</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="30%">No. Surat</th><th width="20%">Kepada</th><th>Tanggal Surat</th><th>Pengirim</th><th width="50%">Perihal</th>
                            </tr>
                        </thead>
                        <tbody>
